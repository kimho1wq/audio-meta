...
class VibeTrackInfo(TrackInfo):
    ...
    def __init__(self, f_dict: dict):
        self.trackId = f_dict['trackId']
        self.isrc = f_dict['isrc']
        self.trackTitle = f_dict['trackTitle']
        self.artistNameList = f_dict['artistNameList']
        self.albumTitle = f_dict['albumTitle']
        self.genreName = f_dict['genreName']

    @classmethod
    def alias(cls):
        return 'vibe_track_info'
    ...
    def to_dict(self):
        return {
            ...
            'artistNameList': self.artistNameList,
...
class AudioMetaDBCollector(DBCollector):

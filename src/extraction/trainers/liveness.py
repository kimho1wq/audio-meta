...
from src.extraction.dataset import LivenessCustomDataset

__all__ = [
    'LivenessTrainer'
]

class LivenessTrainer(Trainer):
    SEQ_DIM = 0
    FEAT_DIM = 1
    ...
    INPUT_PATH = Path('assets/liveness/spectrogram')
    LABEL_PATH = Path('assets/liveness/label')
    ...
    def train(self):
        ...
        train_loader = LivenessCustomDataset(train_loader, self.input_shape)
        test_loader = LivenessCustomDataset(test_loader, self.input_shape)
